  ...
  return (
    <Dialog.Root open={open} onOpenChange={(nextOpen) => !nextOpen && onClose()}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed right-0 top-0 h-full w-96 bg-surface border-l border-border z-50 shadow-lg overflow-y-auto">
          {!volunteer ? null : (
            <>
              <div className="sticky top-0 bg-surface border-b border-border px-6 py-4 flex items-center justify-between">
                <Dialog.Title className="text-lg font-semibold text-text-primary">Volunteer Profile</Dialog.Title>
